...
사용자가 승인한 AI 활용 장면 3장을 사용해 카페24 HTML과 스마트스토어·쿠팡 JPEG 7장을 제작했다. 아래는 실제 HTML을 브라우저에서 연 캡처다.

![상세페이지 실제 브라우저 화면](screenshots/02_상세페이지_첫화면.png)

[전체 페이지 캡처](screenshots/01_상세페이지_전체화면.png)
